...
def main():
    ...
    for file in file_list:
        makefileCmd += f'(python3 {os.getcwd()}/Module_3_2/task3/mapper.py {file} | sort -n | python3 {os.getcwd()}/Module_3_2/task3/combiner.py; wait) &'
        
    makefileCmd = makefileCmd[:-2]
    makefileCmd += f") | sort -n | python3 {os.getcwd()}/Module_3_2/task3/reducer.py {start_date} {end_date} > result.txt"
    print(makefileCmd)
